...
! wave statistics output (Qiyu, 2024)
        ...
        call hbuf_put('TTENDWV',ttend_wave,dble(86400.))
        call hbuf_put('QTENDWV',qtend_wave,86400.*1.e3)
        call hbuf_put('WTENDWV',wtend_wave,86400.)
        !call hbuf_put('TTENDC',dtdt_conv,1.)
        !call hbuf_put('QTENDC',dqdt_conv,1.)
        call hbuf_put('QFILL',water_fill,1.e3)
        call hbuf_put('TTENDWV0',ttend_wave0,dble(86400.))
        call hbuf_put('QTENDWV0',qtend_wave0,86400.*1.e3)
        call hbuf_put('TTENDWVD',ttend_wavedamp,dble(86400.))
        call hbuf_put('QTENDWVD',qtend_wavedamp,86400.*1.e3)
        call hbuf_put('TTENDWVN',ttend_wavenoise,dble(86400.))
        call hbuf_put('QTENDWVN',qtend_wavenoise,86400.*1.e3)
