...
real ttend_wave(nzm),qtend_wave(nzm),wtend_wave(nzm)
real t_wave_local(nzm),q_wave_local(nzm)
real ttend_wave0(nzm),qtend_wave0(nzm)
real ttend_wavedamp(nzm),qtend_wavedamp(nzm)
real bc_tabs0(nzm),bc_qv0(nzm),bc_tabs0_local(nzm),bc_qv0_local(nzm), water_fill(nzm)

integer:: nrestartstart=0
